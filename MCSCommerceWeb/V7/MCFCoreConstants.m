...
/**
 Constants for MCFAlertControllerManager
 */
NSString *const kCoreNoInternetConnectionMessage                = @"Sorry, no Internet connectivity detected. Please reconnect and try again";
NSString *const kCoreNoInternetConnectionErrorInfo              = @"No Internet Connection";
